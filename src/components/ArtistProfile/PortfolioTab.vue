...
const portfolioItems = ref<IPortfolio[]>([
  {
    ...
    pictures: [{ url: 'examples/example1.jpg', documentId: '1', index: 0 }],
  ...
  },
  {
    ...
    pictures: [{ url: 'examples/example2.jpeg', documentId: '2', index: 0 }],
  ...
  },
  {
    ...
    pictures: [{ url: 'examples/example3.jpg', documentId: '3', index: 0 }],
