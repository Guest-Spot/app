  ...
  bookings.value = [
    {
      ...
      shop: {
        documentId: '1',
        name: 'Tattoo Studio',
        pictures: [{ url: 'shops/shop1.jpg', documentId: '1', index: 0 }],
      },
    },
    {
      documentId: '2',
      ...
      shop: {
        documentId: '3',
        name: 'Art Gallery',
        pictures: [{ url: 'shops/shop2.jpg', documentId: '2', index: 0 }],
      },
    },
    {
      documentId: '3',
      ...
      shop: {
        documentId: '3',
        name: 'Art Gallery',
        pictures: [{ url: 'shops/shop3.webp', documentId: '3', index: 0 }],
      },
    },
    {
      documentId: '4',
      ...
      shop: {
        documentId: '5',
        name: 'Tattoo Studio',
        pictures: [{ url: 'shops/shop4.jpg', documentId: '4', index: 0 }],
      },
    },
  ];
});
